      ...
      <div className="p-5">
        ...
        <div className="flex gap-2">
          <button
            ...
            aria-label={t('view_program_aria')}
          >
            <Eye className="w-4 h-4" />
            <span>{t('view_button')}</span>
          </button>
          <IconButton
            onClick={() => onEdit(program.id)}
            icon={<Edit2 />}
            label={t('edit_program_aria')}
            variant="secondary"
          />
          <IconButton
            onClick={() => onDelete(program.id)}
            icon={<Trash2 />}
            label={t('delete_program_aria')}
            variant="danger"
          />
        </div>
      </div>
